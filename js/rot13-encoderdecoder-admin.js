jQuery( document ).ready( function() {
    if (jQuery("#rot13_encoder_decoder_form").length) {
    ...
    if (jQuery("#comments-form").length) {
        ...
        jQuery("#comments-form").on('click', 'input.rot13_comment_submit', function () {
        ...
        jQuery("#comments-form").on('click', 'input.rot13_comment', function () {
